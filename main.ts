...
let spacePlane = sprites.create(img`
    ...
    . f 2 3 2 f 2 3 3 3 3 2 f 2 2 f
    f 2 3 3 3 2 3 3 3 3 3 3 2 f 3 f
    f 3 3 3 3 3 3 3 3 3 3 3 3 2 3 f
    f 2 3 3 3 3 3 3 3 f 3 f 3 3 3 f
    . f 2 3 3 3 3 3 3 f 3 f 3 3 2 f
    . f f 2 3 3 3 3 3 8 3 8 3 3 f .
    . f 2 3 3 3 2 2 3 3 3 3 3 2 f .
    . f 2 3 3 3 3 3 3 3 f 3 3 3 f .
    . . f 3 3 3 3 3 3 3 3 3 3 2 f .
    . . f 2 3 3 3 3 3 3 3 3 3 f . .
    . f 2 f 2 3 3 3 3 3 3 3 2 f . .
    . f 2 2 f f 2 2 3 3 2 2 f . . .
    . f 2 2 2 f f f f f f f . . . .
    . f 2 2 f . f 2 2 f . . . . . .
    . . f f . . . f f . . . . . . .
`, SpriteKind.Player)
info.setLife(3)
